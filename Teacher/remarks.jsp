                ...
                <div class="col-lg-9">
                   <table>
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="#" onclick=" go(<%= stud[i].getrollno() %>,this); ">Outstanding</a></li>
                        <li><a href="#" onclick=" go(<%= stud[i].getrollno() %>,this); ">Very Good</a></li>
                        <li><a href="#" onclick=" go(<%= stud[i].getrollno() %>,this); ">Good</a></li>
                        <li><a href="#" onclick=" go(<%= stud[i].getrollno() %>,this); ">Needs ImprovementFair</a></li>
                        <li><a href="#" onclick=" go(<%= stud[i].getrollno() %>,this); "></a></li>
                    </ul>
                    </div></td>
                       </tr>
                     <% } %>
